...
function addTrFn(obj){
    ...
    trCustom += '<div class="col-sm-10">' +
        ...
        '<input type="text" id="fbUserName_'+subTableLineNum+'" name="fbUserName"  onChange="checkFBUser(this.value,event)" ck_type="ck_required" ck_info="请选择发布人" unselectable="on" placeholder="请选择发布人" onclick="openSelectZtree({\'id\':\'fbUserId_'+subTableLineNum+'\',\'name\':\'fbUserName_'+subTableLineNum+'\',\'isMulti\':\'1\',\'type\':\'1\',\'asyn\':false,\'level\':\'4\',\'url\':\'/system/component/tree/deptUserTree\'})" class="form-control" >' +
...
function checkFBUser(fb,ev){
	    var $subtableRows = $('#otherPeople tr:not(:first)');

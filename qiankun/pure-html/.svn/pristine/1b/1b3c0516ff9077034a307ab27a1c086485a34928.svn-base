package com.sinosoft.sinoep.modules.djgl.ddjs.shyk.dkgl.entity;
 ...
 */
@Entity
@Table(name = "DDJS_SHYK_PARTYCLASS")
public class DkglEntity {
    /** 主键id */
    @Id
    ...
    public DkglEntity(){ super();}


    public DkglEntity(String creUserId, String creUserName, String creDeptId, String creDeptName, String visible, String creTime, String compere, String noteTaker, String numberOfPeople, String actualNumber, String primaryCoverage, String attendants, String leaveAndReasons, String seats, String meetingSituation, String partyOrganizationName, String partyOrganizationId, String meetingTime, String meetingPlace,String meetingType) {
        this.creUserId = creUserId;
        this.creUserName = creUserName;
        this.creDeptId = creDeptId;
        this.creDeptName = creDeptName;

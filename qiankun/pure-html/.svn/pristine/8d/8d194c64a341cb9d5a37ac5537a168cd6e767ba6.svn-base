...
public class SectionStatsServiceImpl implements SectionStatsService {
	...
	@Override
	public PageImpl getList(Pageable pageable,PageImpl pageImpl,String timeRange, String userids,String deptid,String deptname,String flg,String isAll,Integer total) throws Exception {
		...
		if((!StringUtils.isNotBlank(userids))) {//不需要查询任何人
		...
		List<Map<String,Object>> list = jdbcTemplate.queryForList(sql);
		 personalStatsList = setEntity(list,userInfo,BusinessTrips,userOrder,userids);
		//查询某些人的考勤卡号
	 ...
	 * @return
	 */
	private List<PersonalStats> setEntity(List<Map<String, Object>> list,Map<String,SysFlowUserVo>  userInfo,List<Map<String,Object>> BusinessTrips,Map<String,Integer> userOrder,String userids) {
		List<PersonalStats> personalStatsList = new ArrayList<PersonalStats>();

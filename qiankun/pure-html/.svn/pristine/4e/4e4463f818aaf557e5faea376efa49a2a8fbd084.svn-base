package com.sinosoft.sinoep.modules.djgl.ddjs.shyk.jtxx.entity;
 ...
 */
@Entity
@Table(name = "DDJS_SHYK_COLLECTIVE")
public class JtxxEntity {
    /** 主键id */
    @Id
    ...
    public JtxxEntity(){ super();}


    public JtxxEntity(String creUserId, String creUserName, String creDeptId, String creDeptName, String visible, String creTime, String compere, String noteTaker, String numberOfPeople, String actualNumber, String primaryCoverage, String attendants, String leaveAndReasons, String seats, String meetingSituation, String partyOrganizationName, String partyOrganizationId, String meetingTime, String meetingPlace,String tableId,String tableName) {
        this.creUserId = creUserId;
        this.creUserName = creUserName;
        this.creDeptId = creDeptId;
        this.creDeptName = creDeptName;

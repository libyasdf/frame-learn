	...
	if($("#flag").val()=="1"){
	    ...
	    if(bootstrapValidator.isValid()) {
	    	...
	    	//if(f){
	    		var id = $("#id").val(); //打开权限选择窗口
	    		MyLayer.layerOpenUrl({
                    url: "/modules/info/authority/authorityInfo.html?columnId=" + id+"&typeCode=03",
	    			title: "选择默认通知范围"
	    		});
	    	//}else{
...
function addTrFn(obj){
    ...
    trCustom += '<div class="col-sm-10">' +
        ...
        '<input type="text" id="fbUserName_'+subTableLineNum+'" name="fbUserName"  onChange="checkFBUser(this.value,event,'+subTableLineNum+')" ck_type="ck_required" ck_info="请选择发布人" unselectable="on" placeholder="请选择发布人" onclick="openSelectZtree({\'id\':\'fbUserId_'+subTableLineNum+'\',\'name\':\'fbUserName_'+subTableLineNum+'\',\'isMulti\':\'1\',\'type\':\'1\',\'asyn\':false,\'level\':\'3\',\'parentId\':\'fbDeptId'+subTableLineNum+'\',\'deptId\':\'441\',\'rolesNo\':\'C105,D107\',\'url\':\'/system/component/tree/getDeptUserByDeptIdAndRolesNo\'})" class="form-control" >' +
        '<input type="hidden" id="fbUserId_'+subTableLineNum+'" name="fbUserId" /><!-- 人员ID隐藏域 -->' +
        '<input type="hidden" id="fbDeptId'+subTableLineNum+'" name="fbDeptId" />'+
        '<span class="input-group-addon" onclick="openSelectZtree({\'id\':\'fbUserId_'+subTableLineNum+'\',\'name\':\'fbUserName_'+subTableLineNum+'\',\'isMulti\':\'1\',\'type\':\'1\',\'asyn\':false,\'level\':\'3\',\'parentId\':\'fbDeptId'+subTableLineNum+'\',\'deptId\':\'441\',\'rolesNo\':\'C105,D107\',\'url\':\'/system/component/tree/getDeptUserByDeptIdAndRolesNo\'})">' +

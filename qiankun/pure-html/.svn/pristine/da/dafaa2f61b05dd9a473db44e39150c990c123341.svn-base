...
public class VideoContent {
   ...
   private String isFBContentLable;
   private String zdTime;
   private Integer zdOrder;
	...
	@Basic
    @Column(name = "ZD_ORDER")
	public Integer getZdOrder() {
		return zdOrder;
	}

	public void setZdOrder(Integer zdOrder) {
	...
	@Transient
	public String getIsFBContentLable() {
		if("0".equals(isFBContent)) {
			return "否";
		}else {
			return "是";
		}
	...
	public void setIsFBContentLable(String isFBContentLable) {
		this.isFBContentLable = isFBContentLable;
	}

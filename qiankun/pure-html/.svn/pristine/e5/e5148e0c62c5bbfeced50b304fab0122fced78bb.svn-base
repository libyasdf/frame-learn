package com.sinosoft.sinoep.modules.djgl.ddjs.shyk.dxzh.entity;
 ...
 */
@Entity
@Table(name = "DDJS_SHYK_PARTYGROUP")
public class DxzhEntity {
    /** 主键id */
    @Id
    ...
    public DxzhEntity(){ super();}


    public DxzhEntity(String creUserId, String creUserName, String creDeptId, String creDeptName, String visible, String creTime, String compere, String noteTaker, String numberOfPeople, String actualNumber, String primaryCoverage, String attendants, String leaveAndReasons, String seats, String meetingSituation, String partyOrganizationName, String partyOrganizationId, String meetingTime, String meetingPlace) {
        this.creUserId = creUserId;
        this.creUserName = creUserName;
        this.creDeptId = creDeptId;
        this.creDeptName = creDeptName;

...
<script language="javascript" type="text/javascript" src="/js/plugs/My97DatePickerBeta/My97DatePicker/WdatePicker.js"></script>
...
<script type="text/javascript" src="/js/plugs/jquery-ui-1.10.3.custom/js/jquery-1.10.1.js"></script>
<script type="text/javascript" src="/js/plugs/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.js"></script>
<script type="text/javascript" src="/js/dw/collect.js"></script>
<link href="/js/plugs/font-awesome-4.2.0/css/font-awesome.css" rel="stylesheet">

<script src="/js/plugs/echarts/echarts-master/dist/echarts.js"></script>
<script src="/js/plugs/echarts/echarts-master/theme/shine.js"></script>
...
$(document).ready(function(){
	...
	$(".linechart_pic,.piechart_pic,.barchart_pic,.columnchart_pic").click(function(){
		...
		if(amchartdivId!=null){
			...
			if(!amchartdivObj[0]){
				var url="/wenjuan/surveyReport/chartData";
				var data="quId="+quId;
				$.ajax({
					url:url,
					data:data,
...
<body>
	...
	<div class="creatgeSurveyStepBody">
		<div class="creatgeSurveyStepContent bodyCenter">
		            	...
		            	<div class="w-sel" style="margin-top: 4px;">
		                	<div class="selc">
		                    	<div class="selcc tbtag">
		                            ...
		                            <div class="seli"><a class="nx-6 sur_edit" href="#">问卷编辑</a></div>
		                        </div>
		                    </div>
		                </div>
		            </div> -->
				...
				<li><a href=""  class="clickHideMenu csscStep csscStep5"><span class="csscStepLeft">&nbsp;</span><span class="csscStepCenter">数据收集</span><!-- <span class="csscStepRight" >&nbsp;</span> --></a>
					<!-- <div class="a-w-sel">
		            	<div class="w-sel" style="margin-top: 4px;">
		                	<div class="selc">
		                    	<div class="selcc tbtag">
		                            <div class="seli"><a class="nx-1" href="">答卷地址</a></div>
		                            <div class="seli"><a class="nx-2" href="">社交分享</a></div>
		                            <div class="seli"><a class="nx-3" href="">网站组件</a></div>
		                            <div class="seli"><a class="nx-3" href="">微信收集</a></div>
		                        </div>
		                    </div>
		                </div>
		            </div> -->
				...
				<li><span class="csscStep csscStepLine"><span class="csscStepLeft">&nbsp;</span><span class="csscStepRight">&nbsp;</span></span></li>
				<li><a href=""  class="clickHideMenu csscStep csscStep6 active"><span class="csscStepLeft">&nbsp;</span><span class="csscStepCenter">数据分析</span><span class="csscStepRight">&nbsp;</span></a>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="main-tabs-content bodyCenter">
			<div class="tab-content">
				<div class="tab-content-collectTab">
					<a href="javascript:void(0);" class="collectTab tabItem_1 active"><span class="collectTabItemLeft">&nbsp;</span><span>默认报告</span></a>
					<!-- <a href="" class="collectTab tabItem_3"><span class="collectTabItemLeft">&nbsp;</span><span>原始数据</span></a>
			...
			<div class="surveyCollectMiddle">
				...
				<div class="surveyCollectTop">
					<div class="surveyCollectTitleDiv">
						...
						<c:if test="${directory.surveyState==1 }">
						    <div class="scmTabRight" id="stopCollection" onclick="stopCollection(this)">
								<a href="#" class="sbtn25 sbtn25_2">停止收集</a>
						    </div>
						</c:if>
						<c:if test="${directory.surveyState==2 }">
						    <div class="scmTabRight" id="startCollect" onclick="stopCollection(this)">
								<a href="#" class="sbtn25 sbtn25_2">重新收集</a>
						    </div>
						</c:if>
					...
					<div style="padding: 15px 25px;overflow: auto;">
							<div style="overflow: auto;">
								<div style="float: left;" >
									<a href="/wenjuan/surveyReport/defaultReport?surveyId=${surveyId }" class="dw_btn025 tabpic active"><i class="fa fa-refresh"></i>&nbsp;刷新</a>
									<%-- <a href="/da/survey-report!lineChart.action?surveyId=${surveyId }" class="dw_btn025 linepic" style="margin-left: 10px;"><i class="fa fa-bar-chart"></i>&nbsp;柱状图</a>
									<a href="/da/survey-report!pieChart.action?surveyId=${surveyId }" class="dw_btn025 piepic " style="margin-left: 10px;"><i class="fa fa-pie-chart"></i>&nbsp;饼状图</a> --%> 
								</div>
								<div style="float: right;" >
									<a href="/wenjuan/mySurveyAnswer/exportXLS?surveyId=${surveyId }" class="dw_btn025"><i class="fa fa-download"></i>下载数据</a>
								...
								<c:choose>
										...
										<c:when test="${en.quType eq 'FILLBLANK' }">
											...
											<table class="suQuTable" border="0" cellpadding="0" cellspacing="0" style="border: none! important;margin-top: 8px;">
													<tr>
														<td width="15px">&nbsp;</td>
														<td class="bfbTd">回答数：${en.anCount }条&nbsp;&nbsp;<a href="/wenjuan/quFillblank/answers?quId=${en.id}&surveyId=${surveyId}" class="fb_answer" >查看</a></td>
														<td colspan="4">&nbsp;</td>
													</tr>
												</table>
											...
											<table class="suQuTable" border="0" cellpadding="0" cellspacing="0">
												<c:forEach items="${en.quMultiFillblanks }" var="quEn" varStatus="quI">
													<tr class="quTrOptions">
														<td width="15px">&nbsp;</td>
														<td width="520px">${quEn.optionName }</td>
														<td class="bfbTd">回答数：${quEn.anCount }条&nbsp;&nbsp;<a href="/wenjuan/quMultiFillblank/answers?quItemId=${quEn.id}&surveyId=${surveyId}">查看</a></td></td>
														<td colspan="4"></td>
													</tr>
												</c:forEach>
												</table>
...
function stopCollection(dom){
	var id = dom.id;
	if(id=='stopCollection'){
		$.post("/wenjuan/surveyDirectory/stopCollect", { id: surveyId },function(){
			$(dom).find("a").text("重新收集")
	    	dom.id='startCollect';
	    	
	    } );
	}else{
		 $.post("/wenjuan/surveyDirectory/startCollect", { id: surveyId },function(){
			 $(dom).find("a").text("停止收集")
		    	dom.id='stopCollection';

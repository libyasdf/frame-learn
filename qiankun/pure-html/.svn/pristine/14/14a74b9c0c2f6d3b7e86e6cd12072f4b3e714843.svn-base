...
public class AttendenceQueryController {
	...
	public PageImpl getList(PageImpl pageImpl, String timeRange,String cardNumber,String userId) {
		String startDate = "";
		String endDate = "";
		try {
			...
			pageImpl = service.getPageList(pageable, pageImpl, startDate,endDate ,cardNumber,userId);
		} catch (Exception e) {
			e.printStackTrace();

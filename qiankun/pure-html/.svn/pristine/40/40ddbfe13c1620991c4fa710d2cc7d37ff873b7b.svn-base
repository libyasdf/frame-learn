...
function openSelectZtree(json){
    var partyBranchId = json.partyBranchId || "";
    var zid = json.zid || "";
    var id = json.id || "";
    var name =  json.name || "";
    var mark = json.mark || "";
    layer.open({
        id:"selectZtree",
        type: 2,
        content: "/modules/dwgl/common/setDyTree.html",
        area: ['770px', '551px'],
        ...
        success:function(json){
            ...
            // 初始化树
            document.getElementById(iframeId).contentWindow.deptZtree.init(partyBranchId,zid);
            // 初始化tab页

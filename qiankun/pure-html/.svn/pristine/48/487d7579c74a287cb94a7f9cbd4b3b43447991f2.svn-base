...
public class DataDictionarysController {
	 ...
	 * @return
	 */
	@LogAnnotation(value = "delete",opName = "删除字典项")
	 ...
	 * @return
	 */
	@LogAnnotation(value = "query",opName = "根据ID获取一条字典数据")
	 ...
	 * @return
	 */
	@LogAnnotation(value = "query",opName = "添加字典时，校验字典名、字典值不能重复")
	 ...
	 * @return
	 */
	@LogAnnotation(value = "query",opName = "数据字典项排序")
	 ...
	 * @return
	 */
	@LogAnnotation(value = "query",opName = "根据唯一码值查询字典项(类型)")
	 ...
	 * @return
	 */
	@LogAnnotation(value = "update",opName = "数据字典左侧数排序")
	...
	@LogAnnotation(value = "query",opName = "获取父节点")

...
$(function() {
	...
	function showSeatMap(){
		...
		window.open("/modules/zhbg/hygl/meetingNotice/arrangeSeat/seatMap.html?publishState=1&meetingNoticeId="+meetingNoticeId+"&attendDeptId="+attendDeptId+"&userid="+userid);  
...
function showSeatTicket(){
	...
	window.open("/modules/zhbg/hygl/meetingNotice/seatPrint/seatTicket.html?meetingNoticeId="+meetingNoticeId+"&attendDeptId=" + attendDeptId + "&userid="+userid);  

...
public class TakeOutInfoController {
	...
	public PageImpl getPageListDraft(PageImpl pageImpl, String title,String takeFoodTime,String status,String deadlineTime,String name) {
		String startDate = "";
		String endDate = "";
		String startDate1 = "";
		String endDate1 = "";
		try {
			...
			Pageable pageable = new PageRequest(pageImpl.getPageNumber() - 1, pageImpl.getPageSize());
				pageImpl = service.getPageList(pageable, pageImpl, title, startDate,endDate,startDate1,endDate1, status,name);
		} catch (Exception e) {
			e.printStackTrace();
			log.error(e.getMessage(),e);
		}

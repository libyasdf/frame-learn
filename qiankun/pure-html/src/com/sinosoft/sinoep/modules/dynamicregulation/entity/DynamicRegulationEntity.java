package com.sinosoft.sinoep.modules.dynamicregulation.entity;
...
public class DynamicRegulationEntity implements java.io.Serializable {
	/**id*/
	private String id;
	/**创建人id*/
	...
	public DynamicRegulationEntity(){ super();}
}
package com.sinosoft.sinoep.modules.djgl.ddjs.shyk.zbwyh.entity;
 ...
 */
@Entity
@Table(name = "DDJS_SHYK_COMMITTEE")
public class ZbwyhEntity {
    /** 主键id */
    @Id
    ...
    public ZbwyhEntity(){ super();}


    public ZbwyhEntity(String creUserId, String creUserName, String creDeptId, String creDeptName, String visible, String creTime, String compere, String noteTaker, String numberOfPeople, String actualNumber, String primaryCoverage, String attendants, String leaveAndReasons, String seats, String meetingSituation, String partyOrganizationName, String partyOrganizationId, String meetingTime, String meetingPlace,String meetingType) {
        this.creUserId = creUserId;
        this.creUserName = creUserName;
        this.creDeptId = creDeptId;
        this.creDeptName = creDeptName;

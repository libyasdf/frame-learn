 ...
 */
@Entity
@Table(name = "DDJS_SHYK_PARTYCONGRESS")
public class ZbdydhEntity {
    /** 主键id */
    @Id
    ...
    public ZbdydhEntity(){ super();}


    public ZbdydhEntity(String creUserId, String creUserName, String creDeptId, String creDeptName, String visible, String creTime, String compere, String noteTaker, String numberOfPeople, String actualNumber, String primaryCoverage, String attendants, String leaveAndReasons, String seats, String meetingSituation, String partyOrganizationName, String partyOrganizationId, String meetingTime, String meetingPlace,String meetingType) {
        this.creUserId = creUserId;
        this.creUserName = creUserName;
        this.creDeptId = creDeptId;
        this.creDeptName = creDeptName;

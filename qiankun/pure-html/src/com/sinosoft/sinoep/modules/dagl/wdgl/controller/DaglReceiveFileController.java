...
public class DaglReceiveFileController {
	...
	@ResponseBody
	public JSONObject getTransferRepositoryList(DaglReceiveFile receiveFile){
		JSONObject json = new JSONObject();
		try {
			List<DaglReceiveFile> list = fileManageService.getTransferRepositoryList(receiveFile);
			json.put("flag", "1");

...
import com.sinosoft.sinoep.modules.video.background.services.VVideoAndPdfService;
 ...
 */
@Controller
@RequestMapping("/video/content/videoAndPdf")
public class VVideoAndPdfController {

	private Logger log = LoggerFactory.getLogger(this.getClass());

	@Autowired
	private VVideoAndPdfService videoAndPdfService;

...
public class XxkhTestPaper {
	...
	/** 是否有简答题  */ 
	@Transient
	private String isJanDa;
	
	/** 考试试卷下的所有人  */ 
	@Transient
	private String testPaperUpPeople;
	
	public String getTestPaperUpPeople() {
		return testPaperUpPeople;
	}

	public void setTestPaperUpPeople(String testPaperUpPeople) {
		this.testPaperUpPeople = testPaperUpPeople;
	}

	public String getIsJanDa() {
		return isJanDa;
	}

	public void setIsJanDa(String isJanDa) {
		this.isJanDa = isJanDa;
	}

...
public interface BmglService {
	 ...
	 * TODO  动态修改
	 */
	int dynamicUpdate(String jsonStr,String tName,String key,String value, String all, String ranking);
	 ...
	 * @param recId 
	 */
	int isRepetition(String column,String relevancyId,String tName,String chushiId, String recId, String ranking);
	 ...
	 **/
	int queryCountAdd(String danghao,String columnName, String tName, String chushiid,String lastColumnName, String ranking);

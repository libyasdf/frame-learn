...
//					List<XxkhUserPaper> list = testManageService.getUserPaperByTestId(info2.getId(), "");
//					info2.setMarkStatus("0");
//					int  i = 0;
//					for(XxkhUserPaper paper :list) {
//						//如果有已评卷的 就设为评卷中
//						if (paper.getArtificialMarkingState().equals("1")) {
//							i++;
//							info2.setMarkStatus("1");
//						}
//					}
//					//如果有已评卷的数量等于全部人的数量 就设为评卷完成
//					if(i==list.size()) {
//						info2.setMarkStatus("2");
//					}
//				}

	...
	public PageImpl getVideoContentNoticeList(PageImpl page) throws Exception{
		...
		for(Map<String,Object> map : contentList){
			...
			if(null != map.get("contentId")){
				...
				//查询内容下第一条数据
				String sel = "select * from (select a.*,rownum rn from (select t.id,t.file_name,t.file_id,t.cre_time from video_video_and_pdf t where t.info_id ='"+String.valueOf(map.get("contentId"))+"' order by t.cre_time )a ) where rn=1";
				try {

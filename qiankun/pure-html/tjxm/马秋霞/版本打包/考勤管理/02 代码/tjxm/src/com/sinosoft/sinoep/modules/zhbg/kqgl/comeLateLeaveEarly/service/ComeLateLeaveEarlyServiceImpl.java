...
//		}
	...
	public List<Map<String, Object>> findUserData(String startDate, String endDate, String userid) {
		StringBuilder sb =  new StringBuilder("select t.cre_user_id userid,t.cdzt_date date1,t.state from KQGL_COMELATE_LEAVEEARLY_INFO t where  t.visible='1' and t.subflag='5' and t.cre_user_id in(" + userid + ")  ");

...
public class AttendenceQueryServiceImp implements AttendenceQueryService {
	...
	@Override
	public PageImpl getPageList(Pageable pageable, PageImpl pageImpl, String startDate, String endDate, String cardNumber,String userId,String flag) {
		if("1".equals(flag)){//是局长，列表什么都不显示

$(function () {
   ...
   var attentionItem= GetRequest().attentionItem
    var userSelecte;
    var AllSeats;
    $('.info-tip').hide();
    ...
    */
    function publish() {
    	_index=layer.open({
        	type: 2,
            content: '/modules/zhbg/hygl/meetingNotice/seatPrint/meetingAttentionItem.html?noticeId=' + meetingNoticeId+"&fankuiType=" + fankuiType + "&flg=1&attentionItem="+encodeURI(attentionItem),
            area: ['800px', '330px'],

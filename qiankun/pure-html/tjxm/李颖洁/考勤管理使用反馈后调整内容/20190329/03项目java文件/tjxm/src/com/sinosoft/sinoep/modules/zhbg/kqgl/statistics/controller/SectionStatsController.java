...
public class SectionStatsController {
	...
	public PageImpl getList(PageImpl pageImpl,String orgId,String timeRange,String userids,String deptid,String deptname,String flg,String isAll,Integer total){
		...
		try {
			...
			pageImpl=service.getList(pageable,pageImpl,timeRange,userids,deptid,deptname,flg,isAll,total);

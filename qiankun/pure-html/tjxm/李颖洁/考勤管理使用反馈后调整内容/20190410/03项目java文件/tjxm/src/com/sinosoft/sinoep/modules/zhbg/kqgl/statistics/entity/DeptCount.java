...
public class DeptCount {
	...
	public String getAvgEarlyLeaveNum() {
		return "0.00".equals(avgEarlyLeaveNum)?"-":avgEarlyLeaveNum;
	...
	public String getAvgNoComeGoCnt() {
		return "0.00".equals(avgNoComeGoCnt)?"-":avgNoComeGoCnt;
	...
	public String getAvgBusinessCnt() {
		return "0.00".equals(avgBusinessCnt)?"-":avgBusinessCnt;
	...
	public String getAvgOverTimed() {
		return "0.00".equals(avgOverTimed)?"-":avgOverTimed;
	...
	public String getAvgOverTimeh() {
		return "0.00".equals(avgOverTimeh)?"-":avgOverTimeh;

...
//		directory.setSurveyDetailId(detail.getId());
	...
	public PageImpl getPageListDraft(Pageable pageable, PageImpl pageImpl, String wenjuanType,Integer surveyState,String startDate,String endDate,String surveyName) {
		...
		//查询分页数据
		String pageSql = pageSql(pageable,wenjuanType,surveyState,startDate,endDate,surveyName);
	...
	private String pageSql(Pageable pageable, String wenjuanType, Integer surveyState, String startDate, String endDate,
		...
		List<Object> params = querySql(sb,wenjuanType,surveyState,startDate,endDate,surveyNam);
	...
	public void deleteById(String id) {
		StringBuilder sb = new StringBuilder("update t_survey_directory set visibility=0 where id='" + id + "'");
		jdbcTemple.execute(sb.toString());
	...
	public void stopCollect(String id) {
		StringBuilder sb = new StringBuilder("update t_survey_directory set SURVEY_STATE=2 where id='" + id + "'");
		jdbcTemple.execute(sb.toString());
	...
	public void startCollect(String id) {
		StringBuilder sb = new StringBuilder("update t_survey_directory set SURVEY_STATE=1 where id='" + id + "'");
		jdbcTemple.execute(sb.toString());
	}

...
@Service
@Transactional
public class VideoAndPdfServiceImpl implements VVideoAndPdfService {

	private Logger log = LoggerFactory.getLogger(this.getClass());
	
	//资料对应文件的dao
	@Autowired
	private VVideoAndPdfDao videoAndPdfDao;
	 ...
	 */
	@Override
	public List<VVideoAndPdf> getByInfoId(String infoId) {
	...
	public int delete(String fileId) {
		int n = 0;
		try {
			String delSql = "update VVideoAndPdf q set q.visible="+CommonConstants.VISIBLE[0]+" where q.fileId='"+fileId+"'";
			n = videoAndPdfDao.update(delSql);
		} catch (Exception e) {

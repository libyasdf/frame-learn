...
function openDeptTree(subTableLineNum){
	var level = $("#level").val();
	openSelectZtree({'id':'deptId'+subTableLineNum+'','name':'deptName'+subTableLineNum+'','select':true,'asyn':true,'isMulti':'1','height': '450px','check':'','cancle':'','type':'2','level':level,'url':'/system/component/tree/deptTree'});
}

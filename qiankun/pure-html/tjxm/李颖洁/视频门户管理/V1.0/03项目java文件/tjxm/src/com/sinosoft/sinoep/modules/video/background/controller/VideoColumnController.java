    ...
    public JSONObject getShowPage(String columnId){
        ...
        try{
            if(StringUtils.isNotBlank(columnId)){
                ...
                if(entity.getColumnGlUserIds().contains(UserUtil.getCruUserId()) || rolesNo.contains(VideoConstants.VIDEOFBGLYKEROLENO) || rolesNo.contains(VideoConstants.VIDEOFBGLYCHUROLENO)){

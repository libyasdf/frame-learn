...
<script type="text/javascript" charset="utf-8" src="/js/plugs/ueditor1_4_2-utf8-jsp/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/js/plugs/ueditor1_4_2-utf8-jsp/ueditor.all.min.js"> </script>
...
<script type="text/javascript" src="/js/dw/dw-design-init.js"></script>
...
<input type="hidden" id="deptState" value="${survey.deptState }">

<div id="header" >
<div id="header_left">
<%-- <img alt="调问网" src="/images/logo/logo.jpg" > --%>
<!-- <div id="header_title">DIAOWEN-在线问卷编辑器</div> -->
<div class="header_Item header_logo">
		<!-- <a href="/"><img alt="调问网" src="/images/logo/LOGO.png" ></a> -->
		<!-- <div style="font-family: '微软雅黑';font-size:26px;padding-left:10px;">DIAOWEN&nbsp;&nbsp; </div>-->
		&nbsp;&nbsp;
		<span style="font-family: '微软雅黑';font-size: 16px;line-height: 46px;" id="pageHeaderSpan">查看调查问卷</span>
</div>
</div>
<div id="header_right">
<!-- <div style="line-height: 22px;">问卷&nbsp;&nbsp;账号</div> -->
</div>
</div>
...
<%--<div class="tools_tabs">
	...
	<div class="tools_tabs_right"><ul><li style="padding: 0px;font-size: 12px;line-height: 22px;">
	<!-- <a href="http://support.diaowen.net/" target="_black" style="text-decoration: none;color: gray;">帮助</a> -->
	</li></ul></div>
</div>
...
<div class="tools_contents">
	...
	<div id="contactPersonQuestion" style="display: none;" class="tools_item">
		<div class="toolbars">
			<ul class="dragQuUl">
				...
				<li id="emailQuModel" style="display: none;">
					&lt;%&ndash;Email模板 &ndash;%&gt;
					<div class="dwToolbar_icon"></div>
					<div class="dwQuTypeModel">
						<div class="surveyQuItemBody quDragBody">
				...
				<li id="genderQuModel" style="display: none;">
					&lt;%&ndash;性别模板 &ndash;%&gt;
					<div class="dwToolbar_icon"></div>
					<div class="dwQuTypeModel">
						<div class="surveyQuItemBody quDragBody">
				...
				<li id="educationQuModel" style="display: none;">
					&lt;%&ndash;学历模板 &ndash;%&gt;
					<div class="dwToolbar_icon"></div>
					<div class="dwQuTypeModel">
						<div class="surveyQuItemBody quDragBody">
				...
				<li id="maritalQuModel" style="display: none;">
					&lt;%&ndash;婚姻状况模板 &ndash;%&gt;
					<div class="dwToolbar_icon"></div>
					<div class="dwQuTypeModel">
						<div class="surveyQuItemBody quDragBody">
				...
				<li id="salaryQuModel" style="display: none;">
					&lt;%&ndash;收入模板 &ndash;%&gt;
					<div class="dwToolbar_icon"></div>
					<div class="dwQuTypeModel">
						<div class="surveyQuItemBody quDragBody">
	...
	<div id="toolsAuxiliaryQu" class="tools_item">
		<div class="toolbars">
			...
			&lt;%&ndash; <li id="surveyAttrSetToolbar"  class="surveyAttrSetToolbar_li">
				<a href="/design/my-survey-design!previewDev.action?surveyId=${param['surveyId']}" >

...
<script type="text/javascript">
	...
	function draft(){
		  var resId = $('#left_ul').find('a.active').attr("id");
                ...
                layer.open({
                    type: 2,
                    content: '/modules/wenjuan/content/diaowen-design/surveyDirectoryEditForm.html?oper=NEW&resId=' + resId + "&type=" + parameter.type,
                    area: ['600px', 'auto'],
			...
			.ready(
					function(e) {
						...
						TableInit
								.init({
									domId : "right_table1",
									url : "/wenjuan/surveyDirectory/getlist",

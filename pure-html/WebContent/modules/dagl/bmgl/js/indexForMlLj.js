...
function newlyAdded() {
    ...
    layer.open({
        ...
        content: '/modules/dagl/bmgl/form.html?categoryCode=' + $.fn.zTree.getZTreeObj("treeDemo").getSelectedNodes()[0].categoryCode+"&fids="+getFids()+"&where=yulikuMl&basefolderUnit="+basefolderUnit,
        area: ['1100px', '660px'],
        offset: '30px',
        resize: false,
        maxmin: true,

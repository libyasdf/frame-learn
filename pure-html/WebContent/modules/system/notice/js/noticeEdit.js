var fileTypeId = "3e1a1f06594048f5ba7b87b89eee2856";
var workFlowId = "3e1a1f06594048f5ba7b87b89eee2856";
...
function  commitFlow() {
    ...
    if(status =="1"){
        if($("#noticeTitle").val() ==""){
            $("#noticeTitle").val(getCurrentDate("yyyy年MM月dd日")+getcookie("usernm")+"局级通知公告审批");
        }
        var bootstrapValidator = $("#form").data('bootstrapValidator');
        bootstrapValidator.validate();
        if(bootstrapValidator.isValid()){

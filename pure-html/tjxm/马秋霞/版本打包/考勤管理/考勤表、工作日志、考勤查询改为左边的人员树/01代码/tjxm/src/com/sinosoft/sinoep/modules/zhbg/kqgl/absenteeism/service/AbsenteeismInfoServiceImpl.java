...
public class AbsenteeismInfoServiceImpl implements AbsenteeismInfoService {
	...
	public List<Map<String, Object>> findUserData(String startDate, String endDate, String userids) {
		StringBuilder sb = new StringBuilder("select t.cre_user_id userid,t.absenteeism_date date1,t.absenteeism_reason from KQGL_ABSENTEEISM_INFO t where t.visible='1' and t.cre_user_id in(" + userids + ") ");

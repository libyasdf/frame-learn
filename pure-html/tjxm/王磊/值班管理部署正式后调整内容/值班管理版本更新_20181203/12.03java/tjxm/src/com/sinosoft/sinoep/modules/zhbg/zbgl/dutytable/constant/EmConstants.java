...
public class EmConstants {
     ...
     */
    public static final String[] HEADER = {"序号","日期","星期","值班班次","值班员","手机号","带班领导","手机号","普网电话","专网电话"};
    ...
    /**
     * 总值班室查询结果导出excel时 导出的字段名称
     */
    public static final String[] ZZBS_HEADER = {"序号","日期","星期","部门","值班单位","值班班次","值班员","手机号","带班领导","手机号","专网电话","普网电话"};

    /**
     * 总值班室的字段的get方法(依据反射原理)
     */
    public static final String[] ZZBS_GET_METHOD = {"getWatchDate","getWeekday","getCreJuName","getCreChushiName","getClasses","getWatchName","getPhone","getShiftLeaderName","getShiftLeaderPhone","getPrivatePhone","getCommonPhone"};

    /**
     * 总值班室查询结果导出excel时 导出的字段名称
     */
    public static final String[] ZBCX_HEADER = {"序号","日期","星期","部门","值班单位","值班班次","值班员","专网电话","普网电话"};

    /**
     * 总值班室的字段的get方法(依据反射原理)
     */
    public static final String[] ZBCX_GET_METHOD = {"getWatchDate","getWeekday","getCreJuName","getCreChushiName","getClasses","getWatchName","getPrivatePhone","getCommonPhone"};

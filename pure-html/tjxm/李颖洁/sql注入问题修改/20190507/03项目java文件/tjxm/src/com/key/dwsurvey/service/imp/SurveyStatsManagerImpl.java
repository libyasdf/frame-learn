...
public class SurveyStatsManagerImpl extends
	...
	public List<TQuestion> findFrequency(SurveyDirectory survey) {
		List<TQuestion> questions = questionManager.findDetails(survey.getId(),
				"2");
	...
	public List<DataCross> findStatsDataCross(String rowQuId, String colQuId) {
		...
		if (rowQuId != null && !"".equals(rowQuId) && colQuId != null
				&& !"".equals(colQuId)) {
			TQuestion rowQuestion = questionManager.getDetail(rowQuId);
			TQuestion colQuestion = questionManager.getDetail(colQuId);
	...
	public List<DataCross> findDataChart(String quId) {
		if (quId != null && !"".equals(quId)) {
			TQuestion question = questionManager.getDetail1(quId);
	 ...
	 * 单个题目频数统计分析
	 */
	public List<TQuestion> findFrequency_temp(SurveyDirectory survey) {
		List<TQuestion> questions = questionManager.findDetails(survey.getId(),
				"2");

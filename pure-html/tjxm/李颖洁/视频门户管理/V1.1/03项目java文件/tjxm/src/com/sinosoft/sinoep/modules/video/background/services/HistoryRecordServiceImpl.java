...
public class HistoryRecordServiceImpl implements HistoryRecordService{
	...
	public List<HistoryRecord> getLastestHistoryRecord() {
		...
		sql.append("  select t1.id contentId,t1.title contentTitle,t3.file_name fileName,t3.id videoId,t3.file_id uuid,t.cre_time creatime from history_record t  ");
		sql.append(" left outer join VIDEO_CONTENT t1 on t.content_id=t1.id  ");
		sql.append("  left outer join video_video_and_pdf t3 on t.video_id=t3.id ");

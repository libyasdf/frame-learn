...
public class VideoColumnFbUser {
    ...
    public VideoColumnFbUser(String id, String creUserId, String creUserName, String visible, String creTiem, String fbUserId, String fbUserName, String shUserId, String shUserName, String columnId) {
        this.id = id;

    ...
    nodetpl.render(html, {data:data}, function(html) {
        ...
        new AddTr({
            ...
            'addTrFn':function(obj){
                ...
                trCustom += '		<input type="text" id="responsibleUserName'+subTableLineNum+'"  name="responsibleUserName" unselectable="on" onclick="openSelectZtree({\'id\':\'responsibleUserId'+subTableLineNum+'\',\'name\':\'responsibleUserName'+subTableLineNum+'\',\'isMulti\':\'1\',\'type\':\'1\',\'asyn\':false,\'deptId\':\''+serviceDeptId+'\',\'parentId\':\'responsibleDeptId'+subTableLineNum+'\',\'url\':\'/system/component/tree/deptAndUserTree\'})"  class="form-control" CK_type="required"  CK_info="负责人" >';
                trCustom += ' 		<input type="hidden" class="userName" id="responsibleUserId'+subTableLineNum+'" name="responsibleUserId" />';
                trCustom += ' 		<input type="hidden" class="userName" id="responsibleDeptId'+subTableLineNum+'" name="responsibleDeptId" onchange="getIfHwPerson('+subTableLineNum+');"/>';
                trCustom += '		<span class="input-group-addon" onclick="openSelectZtree({\'id\':\'responsibleUserId'+subTableLineNum+'\',\'name\':\'responsibleUserName'+subTableLineNum+'\',\'isMulti\':\'1\',\'type\':\'1\',\'asyn\':false,\'deptId\':\''+serviceDeptId+'\',\'parentId\':\'responsibleDeptId'+subTableLineNum+'\',\'url\':\'/system/component/tree/deptAndUserTree\'})" >';
	...
	//根据负责人id判断是不是会务服务人员
  	$.ajax({
          ...
          data:{
          	...
          	responsibleDeptId:$("#responsibleDeptId"+ids).val()
          },
          success:function(res){
        	 if(res){
        	   if(res!=1){

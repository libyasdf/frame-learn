...
public class DirectorStatsServiceImpl implements DirectorStatsService {
	...
	public PageImpl getList(Pageable pageable,String timeRange, String deptid,String flg) throws Exception {
		...
		if("1".equals(flg) && (!StringUtils.isNotBlank(deptid))) {
		...
		List<Map<String,Object>> totalInfo = getTotalInfo(startDate,endDate,tempUserids);
	...
	private String getCardNums(String uerid,Map<String,DeptCount> map) {
		...
		for (Entry<String, SysFlowUserVo> entry : entrySet) {
			...
			if(StringUtils.isNotBlank(userVo.getCardNumber())){
				System.out.println("..................................");
				System.out.println(userVo.getCardNumber());
		...
		String[] userids = uerid.split(",");
		System.out.println("所要查询的人为"+userids.length);
	...
	private void useridIntoSql(StringBuilder sb,String userids) {

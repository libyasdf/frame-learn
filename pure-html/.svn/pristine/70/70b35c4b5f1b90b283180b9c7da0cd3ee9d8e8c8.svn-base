...
var startTime1 = parseInt(parentMeetingDate.substring(11,13));
var endTime = parentMeetingDate.substring(22,32);
var endTime1 = parseInt(parentMeetingDate.substring(33,35));
...
function lastDay(){
    if($('#selectTime').val()>startTime){
       ...
       /* if($("#rightImage").attr("class")=='glyphicon glyphicon-ban-circle'){
        ...
        selectDate()
    }else if($('#selectTime').val()==startTime){
    	$("#leftImage").css('cursor','not-allowed');
    }
...
function nextDay(){
    if($('#selectTime').val()<endTime){
       ...
       /* if($('#selectTime').val()==endTime){
        ...
        selectDate()
    }else if($('#selectTime').val()==endTime){
    	$("#rightImage").css('cursor','not-allowed');
    }

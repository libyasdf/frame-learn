...
<body>
	...
	<div class="creatgeSurveyStepBody">
		<div class="creatgeSurveyStepContent bodyCenter" >
		            	...
		            	<div class="w-sel" style="margin-top: 4px;">
		                	<div class="selc">
		                    	<div class="selcc tbtag">
		                            ...
		                            <div class="seli"><a class="nx-6 sur_edit" href="/design/my-survey-design.action?surveyId=${surveyId}">问卷编辑</a></div>
		                        </div>
		                    </div>
		                </div>
		            </div> --%>
				...
				<li><a href="/design/my-collect.action?surveyId=${surveyId }"  class="clickHideMenu csscStep csscStep5"><span class="csscStepLeft">&nbsp;</span><span class="csscStepCenter">数据收集</span><!-- <span class="csscStepRight" >&nbsp;</span> --></a>
					<%-- <div class="a-w-sel">
		            	<div class="w-sel" style="margin-top: 4px;">
		                	<div class="selc">
		                    	<div class="selcc tbtag">
		                            <div class="seli"><a class="nx-1" href="/design/my-collect.action?surveyId=${surveyId}">答卷地址</a></div>
		                            <div class="seli"><a class="nx-2" href="">社交分享</a></div>
		                            <div class="seli"><a class="nx-3" href="/design/my-collect.action?surveyId=${surveyId}&tabId=sitecomp">网站组件</a></div>
		                            <div class="seli"><a class="nx-3" href="/design/my-collect.action?surveyId=${surveyId}&tabId=weixin">微信收集</a></div>
		                        </div>
		                    </div>
		                </div>
		            </div> --%>
				...
				<li><span class="csscStep csscStepLine"><span class="csscStepLeft">&nbsp;</span><span class="csscStepRight">&nbsp;</span></span></li>
				<li><a href="/da/survey-report!defaultReport.action?surveyId=${surveyId}"  class="clickHideMenu csscStep csscStep6 active"><span class="csscStepLeft">&nbsp;</span><span class="csscStepCenter">数据分析</span><!-- <span class="csscStepRight">&nbsp;</span> --></a>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="main-tabs-content bodyCenter">
			<div class="tab-content">
				<%-- <div class="tab-content-collectTab">
					<a href="/da/survey-report!defaultReport.action?surveyId=${surveyId}" class="collectTab tabItem_1 active"><span class="collectTabItemLeft">&nbsp;</span><span>默认报告</span></a>
					<a href="/da/my-survey-answer.action?surveyId=${surveyId}" class="collectTab tabItem_3"><span class="collectTabItemLeft">&nbsp;</span><span>原始数据</span></a>
			...
			<div class="surveyCollectMiddle">
				...
				<div class="surveyCollectTop">
					...
					<div class="surveyCollectInfoDiv">
						...
						状态：<span class="collectInfoSpan" id="state">
					...
					<div style="padding: 15px 25px;overflow: auto;">
							<div style="overflow: auto;">
								...
								<div style="float: right;" >
									<%--<a href="/da/my-survey-answer!exportXLS.action?surveyId=${surveyId }" class="dw_btn025"><i class="fa fa-download"></i>下载数据</a>--%>

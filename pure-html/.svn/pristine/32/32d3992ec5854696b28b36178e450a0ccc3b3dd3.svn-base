...
public class TakeOutInfoServiceImpl implements TakeOutInfoService{
	 ...
	 */
	@Override
	public PageImpl getPageList(Pageable pageable, PageImpl pageImpl, String title, String  startDate,String endDate,String startDate1,String endDate1,String status) {
		List<Object> para = new ArrayList<>();
		//总个数
    	StringBuilder sb = new StringBuilder("select count(1) from (");
    	querySql(sb,title,startDate,endDate,startDate1,endDate1,status,para);
    	sb.append(")");
		...
		String pageSql = pageSql(pageable,title,startDate,endDate,startDate1,endDate1,status,para);
	...
	private String pageSql(Pageable pageable, String title, String startDate, String endDate, String startDate1,String endDate1,String status,
			List<Object> para) {
	...
	//拼接列表的sql语句
	private void querySql(StringBuilder sb, String title,String  startDate,String endDate, String startDate1,String endDate1,String status, List<Object> para) {
		sb.append("select t.id,t.title title,t.takefood_time takeFoodTime,t.deadline_time deadlineTime,t.status,t1.orderNo from wmgl_take_out_info t left outer join ");
	...
	public List<TakeOutInfo> getList() {
		...
		StringBuilder sql = new StringBuilder(" select t.id,t.title,t.deadline_time deadlineTime,t.takefood_time takeFoodTime,t.attention_item attentionItem  from wmgl_take_out_info t where t.visible='1' and t.status='1' and t.deadline_time> ?  order by t.deadline_time,to_number(t.title) ");

	...
	if(!check()){
		...
		$.ajax({
			 ...
			 success: function(data){
				 ...
				 if(arr==null){
					 view += "<tr><td colspan='7' style='text-align:center'><span class='glyphicon glyphicon-info-sign' style='color:#0682E3'>暂无数据</span></td></tr>";
				 }else{
					 for ( var i in arr) {
					    	view += "<tr>"
								 ...
								 + "<td style='text-align:center;vertical-align:middle;'>"+arr[i].jdnum+"</td>"
								 + "<td style='text-align:center;vertical-align:middle;'>"+arr[i].maxnum+"</td>"
								 + "<td style='text-align:center;vertical-align:middle;'>"+arr[i].dealtime+"</td>"
								 + "<td style='text-align:center;vertical-align:middle;'>"+arr[i].mindealtime+"</td>"
								 + "</tr>"
					    indexNum++;
					 }
				 }

		...
		for (String day : days) {
			...
			if("01".equals(tempDay)){
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"oneState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twoState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"thirdState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"fourthState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"fiveState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"sixState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"sevenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"eightState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"nineState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"tenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"elevenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twelveState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"thirteenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"fourteenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"fifteenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"sixteenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"seventeenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"eightteenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"nineteenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyOneState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyTwoState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyThirdState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyFourthState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyFiveState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentySixState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentySevenState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyEightState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"twentyNineState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"thirtyState");
				}else{
					//休息日
				...
				if("0".equals(isHoliday)){
					//工作日
					setWorkState(day,person,vacationList,sickCauseList,leaveEarlyList,absenteeisList,businessTripList,trips,overTimeData,"thirtyOneState");
				}else{
					//休息日
								...
								if(StringUtils.isNotBlank(daystate)){
									if("0".equals(state)){
										//迟到
										  ...
										  if(StringUtils.isNotBlank(daystateTitle)){
											  setStateTitleMethod.invoke(person, daystateTitle+";C:"+cdztDate + "因" + cdztresion + "迟到了");
										  }else{
											  setStateTitleMethod.invoke(person,"C:"+cdztDate + "因" + cdztresion + "迟到了");
										  }
									  }else{//早退
										  setStateMethod.invoke(person, daystate+",Z");
										  person.setEarlyLeaveNum(person.getEarlyLeaveNum()+1);
										  if(StringUtils.isNotBlank(daystateTitle)){
											  setStateTitleMethod.invoke(person, daystateTitle+";Z:"+cdztDate +  "因" + cdztresion + "早退了");
										  }else{
											  setStateTitleMethod.invoke(person,"Z:"+cdztDate+   "因" + cdztresion + "早退了");
										  }
									  }
					  ...
					  for (Map<String, Object> absenteeismap : absenteeisList) {
						  ...
						  if(day.compareTo(absenteeisDate)==0){
							  ...
							  if(StringUtils.isNotBlank(daystate)){
								  ...
								  if(StringUtils.isNotBlank(daystateTitle)){
									  setStateTitleMethod.invoke(person, daystateTitle+";X:"+absenteeisDate + "因" + absenteeismReason + "旷工了");
								  }else{
									  setStateTitleMethod.invoke(person,"X:"+absenteeisDate + "因" + absenteeismReason + "旷工了");
								  }
							  }else{

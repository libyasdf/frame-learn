(function ($) {
    ...
    Selectpicker.prototype = {
        ...
        clickListener: function () {
            ...
            /*$(document).off("change.bootstrapSelectChange");
            $(document).on('change.bootstrapSelectChange', this.$element.selector, function() {
                console.log("支持下"+$element.selector);
                that.render();
                that.$element.trigger('changed' + EVENT_KEY, changed_arguments);
                changed_arguments = null;
            });
            $(document).on('focus.bootstrapSelectFocus', this.$element.selector, function() {

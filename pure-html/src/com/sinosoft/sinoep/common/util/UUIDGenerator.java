...
public class UUIDGenerator {
	...
	public String generateUUID32() {
		String uuid = new StringBuffer(36).append(format(getIP())).append(sep).append(format(getJVM())).append(sep)
	...
	public static void main(String args[]) {
		...
		System.out.println(uuid.generateUUID32());
		System.out.println(uuid.generateUUID32().length());
	}

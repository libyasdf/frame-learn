...
public class InfoUtils {
	...
	public static Boolean getAuthList(String columnCode) throws Exception{
		...
		sBuilder.append("select t.id id,t.is_fbfw isFbfw from info_column t where t.column_code = ?");
		List<InfoColumn> columnList = jdbcTemplate.query(sBuilder.toString(), new BeanPropertyRowMapper<InfoColumn>(InfoColumn.class),columnCode);

...
public class VideoColumnServiceImpl implements VideoColumnService{
    ...
    public PageImpl getColumnPageList(Pageable pageable, PageImpl pageImpl, String superId, String columnName, String columnCode,String isShow) {
		...
		List<Object> param = querySql(sb,superId,columnName,columnCode,isShow);
		sb.append(")");
		...
		//查询分页数据
		 String pageSql = pageSql(pageable,superId,columnName,columnCode,isShow,param);
    ...
    private String pageSql(Pageable pageable, String superId, String columnName, String columnCode,String isShow,List<Object> param) {
	...
	private List<Object> querySql(StringBuilder sql, String superId, String columnName, String columnCode,String isShow) {

...
public class MeetingApplyInfo {
	...
	/** 是否手工录入 0：否  1：是*/
	@Column(name = "IF_INPUT_BYHAND")
	private String ifInputByhand;
	
	/** 是否被管理员撤办 0：否  1：是*/
	@Column(name = "if_removed_byadmin")
	private String ifRemovedByadmin;
	...
	public String getIfInputByhand() {
		return ifInputByhand;
	}

	public void setIfInputByhand(String ifInputByhand) {
		this.ifInputByhand = ifInputByhand;
	}
	...
	public String getIfRemovedByadmin() {
		return ifRemovedByadmin;
	}

	public void setIfRemovedByadmin(String ifRemovedByadmin) {
		this.ifRemovedByadmin = ifRemovedByadmin;
	}

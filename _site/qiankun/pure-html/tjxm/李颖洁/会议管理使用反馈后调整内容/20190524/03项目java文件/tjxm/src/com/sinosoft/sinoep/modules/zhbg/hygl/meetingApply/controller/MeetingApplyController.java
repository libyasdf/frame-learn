...
private Logger log = LoggerFactory.getLogger(this.getClass());
	...
	public JSONObject removedByMeetingAdmin(String id,String ifRemovedByadmin,String subflag){
		JSONObject json = new JSONObject();
		json.put("flag", "0");
		try {
			meetingApplyService.removedByMeetingAdmin(id, ifRemovedByadmin,subflag);
			json.put("flag", "1");
		} catch (Exception e) {
			e.printStackTrace();
			log.error(e.getMessage(),e);

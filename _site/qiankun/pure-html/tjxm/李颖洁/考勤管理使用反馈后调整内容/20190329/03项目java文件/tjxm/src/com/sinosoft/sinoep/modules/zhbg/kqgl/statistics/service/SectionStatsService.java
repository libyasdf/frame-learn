...
public interface SectionStatsService {
	 ...
	 * @return
	 */
	PageImpl getList(Pageable pageable,PageImpl pageImpl,String timeRange, String userids,String deptid,String deptname,String flg,String isAll,Integer total)throws Exception;

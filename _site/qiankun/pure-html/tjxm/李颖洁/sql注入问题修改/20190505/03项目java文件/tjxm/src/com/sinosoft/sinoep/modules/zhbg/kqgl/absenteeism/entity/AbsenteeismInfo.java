...
public class AbsenteeismInfo {
	...
	/**旷工类型（0：旷工；1：无故迟到；2：无故早退）*/
	@Column(name = "absenteeism_type")
	private String absenteeismType;
	
	/**旷工人处室ID*/
	@Column(name = "ABS_APPLICANT_CHUSHI_ID")
	private String absApplicantChushiId;
	
	/**旷工人处室名称*/
	@Column(name = "ABS_APPLICANT_CHUSHI_NAME")
	private String absApplicantChushiName;
	...
	public AbsenteeismInfo(String id, String creUserId, String creUserName, String creDeptId, String creDeptName,
			...
			String absApplicantUnitId, String absApplicantUnitName, String absenteeismDate, String absenteeismReason,
			String absenteeismType, String absApplicantChushiId, String absApplicantChushiName, String cz) {
		super();
		this.id = id;
		...
		this.absApplicantChushiId = absApplicantChushiId;
		this.absApplicantChushiName = absApplicantChushiName;
		this.cz = cz;
	}
	...
	public String getAbsApplicantChushiId() {
		return absApplicantChushiId;
	}

	public void setAbsApplicantChushiId(String absApplicantChushiId) {
		this.absApplicantChushiId = absApplicantChushiId;
	}

	public String getAbsApplicantChushiName() {
		return absApplicantChushiName;
	}

	public void setAbsApplicantChushiName(String absApplicantChushiName) {
		this.absApplicantChushiName = absApplicantChushiName;
	}

...
//	            });
       ...
       // $('.app form.row').append($input);
        ...
        //获取当前盒内的档案数量
        if(fids!="" && fileNumberRule.length > 0){
	        $.ajax({
	             ...
	             data: {
	            	...
	            	column:mColName,
	                 tName: tName,
	                 chushiid: $dropdownDom.find("button").attr("data-value"),
...
function getLastNum() {
    ...
    if(ranking ==1){
        ...
        queryLastNum(danghao,columnName,lastColumnName);
...
function queryLastNum(danghao,columnName,lastColumnName) {
    if(tName.indexOf("_dak") == -1){

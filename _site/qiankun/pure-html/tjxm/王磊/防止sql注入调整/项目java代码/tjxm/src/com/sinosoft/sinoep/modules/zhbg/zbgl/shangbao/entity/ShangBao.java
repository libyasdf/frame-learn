package com.sinosoft.sinoep.modules.zhbg.zbgl.shangbao.entity;
...
/**
 * @Author 王富康
 * @Description //TODO 上报表实体类
 * @Date 2018/7/11 18:05
 * @Param
 * @return
 **/
@Entity
...
public class ShangBao {
    ...
    public ShangBao(String unitId, String unitName, String month, String isReport, String reporterId, String reporterName, String reporterTime, String isOnTime) {
        super();
        this.unitId = unitId;
        this.unitName = unitName;
        this.month = month;

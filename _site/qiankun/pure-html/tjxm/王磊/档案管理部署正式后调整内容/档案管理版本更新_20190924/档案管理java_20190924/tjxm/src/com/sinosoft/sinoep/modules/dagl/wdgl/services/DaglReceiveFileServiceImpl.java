...
public class DaglReceiveFileServiceImpl implements DaglReceiveFileService {
	...
	public int batchUpdate(String ids,String type) {
		...
		jpql += " and (t.state not in('"+DAGLCommonConstants.WEN_DIAN_STATUS[1]+"','"+DAGLCommonConstants.WEN_DIAN_STATUS[3]+"','"+DAGLCommonConstants.WEN_DIAN_STATUS[4]+"') or t.state is null)";
		log.info(jpql);
		return dao.update(jpql,paraList.toArray());
	}

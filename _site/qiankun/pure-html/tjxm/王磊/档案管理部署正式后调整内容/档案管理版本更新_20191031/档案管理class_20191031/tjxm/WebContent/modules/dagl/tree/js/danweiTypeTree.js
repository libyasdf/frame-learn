...
//	        },//添加复选框
	...
	function onClick(event, treeId, treeNode) {
        ...
        if(treeNode.pId != "" && treeNode.pId != null) {//排除点击全宗的点击事件
            typeTreeLjToMenlei.init({columnName: treeNode.columnName, id: treeNode.id});
            initPage();
...
//	}
	...
	var init = function(json) {
		...
		var url ="/dagl/xtpz/category/personnelTree?codeId="
		...
		$.getJSON(url, function(json) {
			...
			if ("1" == json.flag) {
				...
				ztree = $.fn.zTree.init($("#treeDemo1"), setting, json.data.rows);

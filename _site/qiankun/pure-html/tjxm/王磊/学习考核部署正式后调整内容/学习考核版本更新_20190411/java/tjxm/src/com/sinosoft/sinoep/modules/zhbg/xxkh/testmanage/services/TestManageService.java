...
public interface TestManageService {
	 ...
	 * @return PageImpl
	 */
	 List<XxkhUserPaper> getTestPersonCountInUserPaper(XxkhUserPaper paper);
	 ...
	 * @throws Exception 
	 */
	JSONObject saveReportPerson(String id, String personIds, String deptId,String name) throws Exception;
	 ...
	 **/
	List<XxkhUserPaper> getTestOfFristPaperId(XxkhTestInfo info);
	 ...
	 * @return PageImpl
	 */
	PageImpl getTestPersonInfoList(Pageable pageable, PageImpl pageImpl, XxkhUserPaper userPar);
}

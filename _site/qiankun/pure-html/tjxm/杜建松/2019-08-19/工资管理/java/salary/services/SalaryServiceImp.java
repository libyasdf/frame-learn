...
public class SalaryServiceImp implements SalaryService{
	...
	public PageImpl getlistBootHql(Pageable pageable, PageImpl pageImpl, String name, String yearMonth,String idCarNo,String flag,String personId) {
		...
		if(StringUtils.isNotBlank(personId)){
			querySql.append("  and UPPER(t.idCarNo) in ( " + CommonUtils.solveSqlInjectionOfIn(getUserVo(personId),para)+")");
		}
		if("1".equals(flag)){
			//查询的是我的工资
	                ...
	                for (int rowIndex =1;rowIndex<=sheet.getLastRowNum();rowIndex++){
	                   ...
	                   String yearMonth;
	                    ...
	                    if("".equals(idCard)){
	                    	...
	                    	entity.setIdCarNo(idCard.trim().toUpperCase());
	                    }
	                   ...
	                   if("".equals(DutySalary)){
						...
						String bigMedicalInsurance=ImportFileUtil.getRowCellValue(row,(short)19);
						if("".equals(bigMedicalInsurance)){

							entity.setBigMedicalInsurance("0.00");
						} else if(!bigMedicalInsurance.matches("-?[0-9]+.?[0-9]+")){
							flag="1";
							errorNum += 1;
							errorReason="数据格式错误";
							if(mark.length() < 2000){
								if(errorNum % 3== 0){
									mark.append((rowIndex+1)+"行大额医保必须为数值  \t\n");
								}else{
									mark.append((rowIndex+1)+"行大额医保必须为数值   \t");
								}
							}
							...
							flag="1";
							entity.setBigMedicalInsurance(df.format(Double.valueOf(bigMedicalInsurance)));
						}
	                    
	                    String medicalInsurance=ImportFileUtil.getRowCellValue(row,(short)20);
	                    ...
	                    String pensionAnnuity=ImportFileUtil.getRowCellValue(row,(short)21);
	                    ...
	                    String rentSalary=ImportFileUtil.getRowCellValue(row,(short)22);
	                    ...
	                    String buckleSalary=ImportFileUtil.getRowCellValue(row,(short)23);
	                    ...
	                    String dueSalary=ImportFileUtil.getRowCellValue(row,(short)24);
	                    if("".equals(dueSalary)){
	                    ...
	                    String buckleLoan=ImportFileUtil.getRowCellValue(row,(short)25);
	                    ...
	                    String loanInterest=ImportFileUtil.getRowCellValue(row,(short)26);
	                    ...
	                    String personalIncomeTax=ImportFileUtil.getRowCellValue(row,(short)27);
	                    ...
	                    String propertyFee=ImportFileUtil.getRowCellValue(row,(short)28);
	                    ...
	                    String heatingSubsidies=ImportFileUtil.getRowCellValue(row,(short)29);
	                    ...
	                    String travelAllowance=ImportFileUtil.getRowCellValue(row,(short)30);
	                    ...
	                    String phoneAllowance=ImportFileUtil.getRowCellValue(row,(short)31);
	                    ...
	                    String publicTransportation=ImportFileUtil.getRowCellValue(row,(short)32);
						...
						String deductSurcharges=ImportFileUtil.getRowCellValue(row,(short)33);
						if("".equals(deductSurcharges)){
							entity.setDeductSurcharges("0.00");

						} else if(!deductSurcharges.matches("-?[0-9]+.?[0-9]+")){
							flag="1";
							errorNum += 1;
							errorReason="数据格式错误";
							if(mark.length() < 2000){
								if(errorNum % 3== 0){
									mark.append((rowIndex+1)+"行专项附加扣除必须为数值 \t\n");
								}else{
									mark.append((rowIndex+1)+"行专项附加扣除必须为数值 \t");
								}
							}
							...
							flag="1";
							entity.setDeductSurcharges(df.format(Double.valueOf(deductSurcharges)));
						}
	                    
	                    String unpaidLeaveAllowance=ImportFileUtil.getRowCellValue(row,(short)34);
	                    if("".equals(unpaidLeaveAllowance)){
	                    	...
	                    	if(mark.length() < 2000){
    							if(errorNum % 3== 0){
    								mark.append((rowIndex+1)+"行未休假补贴必须为数值 \t\n");
    							}else{
    								mark.append((rowIndex+1)+"行未休假补贴必须为数值 \t");
    							}
    						}
	                    ...
	                    String doublePay=ImportFileUtil.getRowCellValue(row,(short)35);
	                    if("".equals(doublePay)){
	                    ...
	                    String meritPay=ImportFileUtil.getRowCellValue(row,(short)36);
	                    if("".equals(meritPay)){
	                    ...
	                    String heatstrokePreventionSubsidy=ImportFileUtil.getRowCellValue(row,(short)37);
	                    ...
	                    String winterHeatingSubsidy=ImportFileUtil.getRowCellValue(row,(short)38);
	...
	public Salary saveForm(Salary info) {
			...
			String bigMedicalInsurance = info.getBigMedicalInsurance();
			if(StringUtils.isBlank(bigMedicalInsurance)){
				salary.setBigMedicalInsurance("0.00");
			}else{
				salary.setBigMedicalInsurance(df.format(Double.valueOf(bigMedicalInsurance)));
			}

			String deductSurcharges = info.getDeductSurcharges();
			if(StringUtils.isBlank(deductSurcharges)){
				salary.setDeductSurcharges("0.00");
			}else{
				salary.setDeductSurcharges(df.format(Double.valueOf(deductSurcharges)));
			}

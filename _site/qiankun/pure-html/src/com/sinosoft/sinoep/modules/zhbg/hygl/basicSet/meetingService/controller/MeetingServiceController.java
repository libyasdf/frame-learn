...
public class MeetingServiceController {
	 ...
	 * @return
	 */
	@LogAnnotation(opType = OpType.UPDATE,opName = "修改会务服务项目信息")
	@ResponseBody
	@RequestMapping("edit")
	 ...
	 * @return
	 */
	@LogAnnotation(opType = OpType.SAVE,opName = "保存会务服务项目信息")
	@ResponseBody
	 ...
	 * @return
	 */
	//@LogAnnotation(opType = OpType.QUERY,opName = "获取所有的会务服务（会议申请加载会务服务项）")
	 ...
	 * @return
	 */
	@LogAnnotation(opType = OpType.DELETE,opName = "查询会务服务项目信息列表")
	@ResponseBody

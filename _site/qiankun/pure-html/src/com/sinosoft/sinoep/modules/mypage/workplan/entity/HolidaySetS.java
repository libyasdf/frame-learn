...
public class HolidaySetS {
	 ...
	 * @param yibanid
	 */
	public HolidaySetS(String id,String yearMonth, String nowDate, String creTime, String creUserId, String creUserName, String creDeptId,
	...
	public HolidaySetS(String id, String isHoliday) {
		super();
		this.id = id;
		this.isHoliday = isHoliday;
	}
